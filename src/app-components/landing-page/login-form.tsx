...
import { loginBuyer, getSocialAuthURL, getSocialAuthCallBack } from "@/api-services/auth";
    ...
    <div className="w-full">
      <div className="space-y-4 flex flex-col justify-center items-center">
        ...
        <div className="space-y-2 pt-3">
          <Button onClick={() => getSocialAuthLink('google')} className="w-100 h-11 border bg-white text-black hover:bg-transparent rounded-none flex items-center justify-center gap-2 text-sm">
